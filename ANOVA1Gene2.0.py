...
ANOVAtoCSV(superANOVAResults, 'tstsuperANOVAResults.csv')
ANOVAtoCSV(subANOVAResults, 'tstsubANOVAResults.csv')
TukeyToCSV(superTukeyResults, 'tstsuperTukeyResults.csv')
TukeyToCSV(subTukeyResults, 'tstsubTukeyResults.csv')
