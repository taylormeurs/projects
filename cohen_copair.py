...
def cohenToCSV(d, csvName):
    header = ['isoform', 'amino acid', 'population1', 'population2', 'cohens_d']
...
for isoform in isoforms:
    ...
    if found:
        ...
        # subDResults[isoform] = cohenTest(runForSub)
        # superDResults[isoform] = cohenTest(not runForSub)
...
cohenToCSV(superDResults, 'co_pair/' + sys.argv[2] + 'superDResults.csv')
cohenToCSV(subDResults, 'co_pair/' + sys.argv[2] + 'subDResults.csv')
