...
ANOVAtoCSV(superANOVAResults, sys.argv[2] + 'superANOVAResults.csv')
ANOVAtoCSV(subANOVAResults, sys.argv[2] + 'subANOVAResults.csv')
TukeyToCSV(superTukeyResults, sys.argv[2] + 'superTukeyResults.csv')
TukeyToCSV(subTukeyResults, sys.argv[2] + 'subTukeyResults.csv')
